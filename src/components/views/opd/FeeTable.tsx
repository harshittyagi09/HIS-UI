...
import { removeSelectedDoctor, setOpdDiscountData, setSelectedDoctor, setBillingData, clearSelectedDoctorsData } from '../../../redux/actions/OpdRegAction';
...
const FeeTable = (props: any) => {
    ...
    }, [props?.billingData?.patient_category_id])
