...
export default function EditDoctorModal(props: any) {
  ...
  const { setReloadData, doctorID, selectedDoctorId, showEditDoctor, setShowEditDoctor, doctorTypes, departments, doctorDataDetails, specialization } = props;
              ...
              <Container>
                ...
                <RadioBtnsContainer>
                  ...
                  <input
                    ...
                    type="radio"
                    checked={doctorData?.DoctorCategory === 'Specialist' || doctorData?.DoctorCategory === 'GS'}
                    name="DoctorCategory"
                    value="GS"
                    onChange={handleChange}
                  /> Specialist
                  <input
                    style={{ marginRight: '5px', accentColor: '#0d839252' }}
                    type="radio"
                    checked={doctorData?.DoctorCategory === 'Not Applicable' || doctorData?.DoctorCategory === ''}
                    name="DoctorCategory"
                    value=''
                    onChange={handleChange}
                  /> Not Applicable
