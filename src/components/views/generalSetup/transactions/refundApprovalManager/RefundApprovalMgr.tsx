...
import { TableCellData } from './RefundApprovalManager.styles';
import { Link } from '@mui/material';
import RefundAppForMgrModal from '../../../opd/transactions/RefundAppForMgrModal';
...
export default function RefundApprovalMgr(props: any) {
                                ...
                                filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row: any, index: any) => (
                                    <TableRow key={row.id}>
                                        <TableCellData>
                                            ...
                                            {
                                                showModal && <RefundAppForMgrModal showModal={showModal} setShowModal={setShowModal} setReloadData={setReloadData} selectedBill={selectedBill} billNo={row.BillNo} patientId={row.PatientId} />
                                            }
                                        </TableCellData>
