                                ...
                                {filteredUserRoles?.map((row: any, index: any) => (
                                    ...
                                    >
                                        ...
                                        <TableCellData style={{ minWidth: '100px', padding: '0px 20px', width: '10%' }} align="center">
                                            ...
                                            {
                                                showEditRole && <EditRoleModal roleId={row?.roleId} roleName={row?.roleName} selectedRawId={selectedRawId} showEditRole={showEditRole} setShowEditRole={setShowEditRole} selectedRoleId={selectedRoleId} setReloadData={setReloadData} />
                                            }
                                        </TableCellData>
