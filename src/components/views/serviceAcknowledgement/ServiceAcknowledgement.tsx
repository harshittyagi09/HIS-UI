...
import { Heading, TableCellData } from './ServiceAcknowledgement.styles';
        ...
        <div style={{ padding: '10px', backgroundColor: '#e0e0e05e' }}>
            <div style={{ border: '1px solid transparent', backgroundColor: '#55c79c', padding: '0px 10px', display: 'flex', justifyContent: 'space-between' }}>
                <div style={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <div style={{ fontSize: '25px', fontWeight: '700', color: 'white', padding: '0px 10px' }}>Service Acknowledge</div>
                </div>
                        ...
                        <Table sx={{ minWidth: 650 }} aria-label="simple table">
                            <TableHead>
                                <TableRow>
                                    ...
                                    <TableCellData style={{ fontWeight: '400', fontSize: '13px', backgroundColor: '#40b4c1', color: 'white', textAlign: 'center', width: '8%' }} align="right">OPD No.</TableCellData>
