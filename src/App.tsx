...
import Eopd from './components/views/e-opd/Eopd';
import PaymentAcknowledge from './components/views/generalSetup/transactions/paymentAcknowledge/PaymentAcknowledge';
import TransactionsHandling from './components/views/generalSetup/masters/TransactionsHandling';
import OpdBillRefundPrint from './components/views/printViews/OpdBillRefundPrint';
  ...
  return (
    <Router>
      <Switch>
        ...
        <Route path="/opdBillRefundPrint" component={OpdBillRefundPrint} />
        <Layout>
          ...
          <Route path="/eopd" component={Eopd} />
          <Route path="/paymentAcknowledge" component={PaymentAcknowledge} />
          <Route path="/transactionsHandling" component={TransactionsHandling} />
        </Layout>
      </Switch>
    </Router>
  );
